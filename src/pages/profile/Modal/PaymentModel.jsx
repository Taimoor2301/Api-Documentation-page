	...
	return (
		<motion.div
			...
			<motion.div
				...
				className='bg-white max-w-7xl mx-auto lg:w-[80vw] w-[95vw] h-[90vh] lg:h-[97vh] rounded-xl p-3 shadow-md flex flex-col items-center gap-10 relative'
				...
				<div className='w-full h-full'>{activeTab !== "crypto" ? <PeerPayment /> : <CryptoPayment />}</div>
			</motion.div>
		</motion.div>
	);
};
...
const PeerPayment = () => {
	return (
		<div className='flex flex-col xl:flex-row gap-2 h-full'>
			<div className='hidden xl:block rounded-xl overflow-hidden flex-[1]'>
				<img
					src={img2}
					alt=''
					className='w-full h-full object-center object-cover'
			...
			<div className='border rounded-xl px-3 py-5 grid grid-cols-2 gap-1 md:gap-4 flex-[2] place-content-start'>
				<PeerForm />
			</div>
		</div>
	);
...
const PeerForm = ({}) => {
	return (
		<>
			<h1 className='col-span-full text-md font-poppins font-medium md:pt-4 pb-4 md:pb-10 text-xl'>Payment Mehtod</h1>
